...
class BuildGraphNodeFetcher : BuildGraphProjectDataFetcher() {

    override fun getType() = "BuildGraphNodes"

    override fun processFile(buildGraphFile: Document): List<DataItem> {
        return BuildGraphParser.parseNodes(buildGraphFile).toList().sortedBy { it.value }
    }
